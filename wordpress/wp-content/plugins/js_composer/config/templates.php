...
if (!function_exists('upper_studio_templates_for_vc') && defined('LONDRES_PLG_PATH') && file_exists(LONDRES_PLG_PATH."lib/upper-studio/upper-studio-templates.php")) 
	require_once(LONDRES_PLG_PATH."lib/upper-studio/upper-studio-templates.php");
