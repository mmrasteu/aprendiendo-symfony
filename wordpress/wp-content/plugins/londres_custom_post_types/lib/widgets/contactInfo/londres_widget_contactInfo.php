...
class Londres_ContactInfo_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'contact_info_widget', 'description' => esc_html__('Minimalist contact information.', 'londres'));
...
?>  
    <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>">&#8212; <?php esc_html_e('Title', 'londres'); ?> &#8212;<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo wp_kses_post($title); ?>" /></label></p> 
       ...
       <p><label for="<?php echo esc_attr($this->get_field_id('type')); ?>">&#8212; <?php esc_html_e('Info Type', 'londres'); ?> &#8212;<br/>
       ...
       <p><label for="<?php echo esc_attr($this->get_field_name('content')); ?>">&#8212; <?php esc_html_e('Info Content', 'londres'); ?> &#8212;      
    ...
    <div class="widget widget-contact-info">
		...
		<div class="widget-contact-content <?php if ($center) echo "centered"; ?>">
			...
			<i class="fa <?php
			    if ($type != "other"){
				    switch ($type){
					    case "telephone": echo "ion-ios-telephone"; break;
					    case "email": echo "ion-ios-email"; break;
					    case "address": echo "ion-ios-location"; break;
				    }
...
register_widget('Londres_ContactInfo_Widget');
