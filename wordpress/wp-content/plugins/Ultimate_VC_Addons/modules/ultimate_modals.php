	...
	class Ultimate_Modals
	{
		...
		function register_modal_assets()
		{
			...
			if($bsf_dev_mode === 'enable') {
				...
				$ext = '';
				wp_register_script("ultimate-vc-addons-modal-customizer", $js_path."modernizr-custom.js",array('jquery'),ULTIMATE_VERSION);
				wp_register_script("ultimate-vc-addons-modal-classie", $js_path."classie.js",array('jquery'),ULTIMATE_VERSION);
				wp_register_script("ultimate-vc-addons-modal-froogaloop2", $js_path."froogaloop2-min.js",array('jquery'),ULTIMATE_VERSION);
				wp_register_script("ultimate-vc-addons-modal-snap-svg", $js_path."snap-svg.js",array('jquery'),ULTIMATE_VERSION);
				wp_register_script("ultimate-vc-addons-modal", $js_path."modal.js",array('jquery', 'ultimate-vc-addons-modal-customizer', 'ultimate-vc-addons-modal-classie', 'ultimate-vc-addons-modal-froogaloop2', 'ultimate-vc-addons-modal-snap-svg' ),ULTIMATE_VERSION);
			}
			else {
			...
			wp_register_script("ultimate-vc-addons-modal-all", UAVC_URL.'assets/min-js/modal-all.min.js',array('jquery'),ULTIMATE_VERSION);
		...
		function modal_shortcode($atts, $content = null)
		{
			...
			if($overlay_bg_color !== ''){
				if(strlen($overlay_bg_color) <= 7)
					$overlay_bg = uavc_hex2rgb($overlay_bg_color,$overlay_bg_opacity);
				else
