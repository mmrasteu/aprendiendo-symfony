...
Class londres_walker_nav_menu extends Walker_Nav_Menu {
...
Class londres_walker_nav_menu_outsider extends Walker_Nav_Menu {
...
Class londres_walker_nav_menu_mobile extends Walker_Nav_Menu {
	function start_lvl( &$output, $depth = 0, $args = array() ) {
	    $indent = ( $depth > 0  ? str_repeat( "\t", $depth ) : '' );
	    $display_depth = ( $depth + 1);
	    $classes = array(
...
Class londres_walker_nav_menu_outsider_mobile extends Walker_Nav_Menu {
