...
get_header(); londres_print_menu();
	...
	$sidebar = londres_convert_to_class(get_post_meta($post->ID, 'sidebars_available_value', true));
				...
				<section class="page_content" id="section-<?php echo esc_attr(get_the_ID()); ?>">
					...
					<?php 
						if (function_exists('vc_is_inline') && vc_is_inline()){
							...
							$content_post = get_post($londres_thisPostID);
							...
							<?php
							$shortcodes_custom_css = get_post_meta( $londres_thisPostID, '_wpb_shortcodes_custom_css', true );
