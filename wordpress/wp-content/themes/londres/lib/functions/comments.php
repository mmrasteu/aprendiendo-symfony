 ...
 */
function londres_comments($comment, $args, $depth) {
		...
		<div class="comment-box">
			...
			<div class="comment-reply">
				...
				<div class="comment-date post-info">
					...
					<div class="reply">
						<?php if (!function_exists('icl_object_id')) comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> get_option("londres_reply_text")))); else comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> esc_html__("Reply", "londres")))); ?>
